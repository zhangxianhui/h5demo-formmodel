  ...
  <div class="wrap">
        ...
        <div class="test-table">
            <el-table class="table" :data="list" style="width: 100%" stripe  @sort-change="handleSortChange" :default-sort="{prop: tableData.type, order: tableData.descString}">
                ...
                <el-table-column prop="count1" label="转发+评论" sortable="false"> </el-table-column>              
                <el-table-column prop="count2" label="总合计" sortable="false"> </el-table-column>                                 
		        </el-table>
