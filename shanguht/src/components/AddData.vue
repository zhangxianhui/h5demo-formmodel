  ...
  <div id="addData" class="body">
    ...
    <div class="infoBox">
      <div class="pannel">
        ...
        <p>
          <label>节假日描述: </label>
          <textarea rows="3" cols="30" v-model="data.description" ></textarea>
        </p>
        <p class="ico-box">
            <label style="float:left">节假日图标: </label>
           <div class="imgdiv">
                <a class="imgSrc">
                     <img :src="imgDataUrl" id="image" v-show="isShowImg">
                </a>
...
export default {
  ...
  methods: {
    ...
    save(resp) {
      ...
      this.httpService
        .addData("/api/v2/holiday/picture", data)
        .then(function(resp) {
